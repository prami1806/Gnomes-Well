...
public class GameManager :Singleton<GameManager>
{
    ...
    // The 'current' gnome ( as opposed to the dead ones)
    Gnome currentGnome;
    ...
    // The 'get;set;' make this a property, to make it
    // show up in the list of methods in the Inspector for
    // Unity Events
    ...
    // The sound to play when a gnome dies
    ...
    void CreateNewGnome()
    {
        ...
        // rigidbody the Gnome object wants
    ...
    void RemoveGnome()
    {
        ...
        {
            // The gnome is no longer holding the treasure
            currentGnome.holdingTreasure = false;

            // Mark this object as not the player(so that
            // colliders won't report when the object hits them)
    ...
    // Called when Menu button is tapped, and when the Resume Game button
    // is tapped
