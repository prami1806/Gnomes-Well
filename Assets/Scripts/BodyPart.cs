...
public class BodyPart : MonoBehaviour
{
    ...
    //Every frame, if we're detached, remove physics if the rigidbody
    // is sleeping. This means this detached body part will
    // never get in the way of the gnome.
    ...
    // Swaps out the sprite for this part based on what kind of damage
    // was received
